<template>
  <div class="musicDetail">
    ...
    <div class="Lyric" ref="Lyric" v-show="imgShow">
      <p
        v-for="(item, i) in lyric"
        :key="i"
        :class="{
          active_2:
            currentTime * 1000 >= item.time && currentTime * 1000 < item.after,
        }"
      >
        {{ item.lrc }}
      </p>
    ...
    <div class="detailBottom">
      ...
      <div class="bottom">
        ...
        <svg class="icon zanting" aria-hidden="true" v-else @click="stop">
      ...
      if (p_2) {
        if (p_2.offsetTop > this.$refs.Lyric.clientHeight / 2) {
          this.$refs.Lyric.scrollTop =
            p_2.offsetTop - this.$refs.Lyric.clientHeight / 1.4;
        }
      }
